...
<p>Так же в сборку включен пакетный менеджер bower. Файлы js подключается автоматически при запуске gulp, а css могут возникать проблемы.В случае, если после установка css библиотеки и запуска gulp, ваша библиотека не появится в папке app/libs, то перенесите файлы в ручную.</p>
